...
public class Config {
    ...
    public static String screenShotSavePath = TEMP_DIR + "1.png";

    // ADB截图保存路径1
    public static String screenShotSavePath1 = TEMP_DIR + "2.png";

    // ADB截图保存路径2
    public static String screenShotSavePath2 = TEMP_DIR + "3.png";
